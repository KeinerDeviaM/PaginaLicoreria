    ...
    <div className="page">
      <section className="card reveal-on-scroll hero" style={{ marginBottom: 18 }}>
        <div className="stack" style={{ justifyContent: 'space-between', alignItems: 'end', gap: 16, flexWrap: 'wrap' }}>
          <div>
            <div className="small" style={{ color: '#d4af37', marginBottom: 8 }}>Gestión de cuentas</div>
            <h1>Usuarios</h1>
            <p className="small">Consulta cuentas de clientes, trabajadores y administradores.</p>
          </div>
      ...
      <section className="card reveal-on-scroll">
        <div className="table-header">
          ...
          <span className="result-pill">{filtered.length} usuarios</span>
        </div>
